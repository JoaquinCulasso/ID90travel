...
class HotelFilterDTO //implements \JsonSerializable
{
...
//            'price_low' => empty($this->price_low) ? null : $this->price_low,
//            'price_high' => empty($this->price_high) ? null : $this->price_high
//        ];
//    }
}