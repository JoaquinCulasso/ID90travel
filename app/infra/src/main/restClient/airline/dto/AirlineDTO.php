...
namespace Id90travel\infra\src\main\restClient\airline\dto;

use Id90travel\core\src\main\rest\airline\model\Airline;

class AirlineDTO implements \JsonSerializable
{
    private int $id;
    private string $name;
    private string $code;
     ...
     */
    public function __construct(int $id, string $name, string $code, bool $sign_in_available, bool $sign_up_available, string $display_name, bool $is_commercial, bool $employee_number_required, bool $partner, string $lang, string $currency, array $email_domains, string $airline_blog_uri, string $white_label_url)
    {
        $this->id = $id;
        $this->name = $name;
        $this->code = $code;
    ...
    public static function fromJson($json): AirlineDTO
    {
        return new self(
            $json['id'],
            $json['name'],
            $json['code'],
            $json['sign_in_available'],
            $json['sign_up_available'],
            $json['display_name'],
            $json['is_commercial'],
            $json['employee_number_required'],
            $json['partner'],
            $json['lang'],
            $json['currency'],
            $json['email_domains'],
            $json['airline_blog_uri'],
            $json['white_label_url']
        );
    }
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'name' => $this->name,
            'code' => $this->code,
            'sign_in_available' => $this->sign_in_available,
            'sign_up_available' => $this->sign_up_available,
            'display_name' => $this->display_name,
            'is_commercial' => $this->is_commercial,
            'employee_number_required' => $this->employee_number_required,
            'partner' => $this->partner,
            'lang' => $this->lang,
            'currency' => $this->currency,
            'email_domains' => $this->email_domains,
            'airline_blog_uri' => $this->airline_blog_uri,
            'white_label_url' => $this->white_label_url
        ];
    }
}